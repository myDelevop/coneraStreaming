...
public class OrdinalClassStdDevCouple  extends ClassStdDevCouple {
	...
	*/
	...
	OrdinalClassStdDevCouple(int i, Node n, Neighbourhood nh, ContinuousAttribute target, WeightI weight) {
